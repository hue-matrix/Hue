...
export const HeroSlideshow = () => {
    ...
    return (
        // Adjusted height/width for story-like aspect ratio (approx 9:16)
        <div className="relative w-full max-w-md h-[700px] md:h-[800px] rounded-[2.5rem] overflow-hidden group shadow-2xl mx-auto">
            {/* Progress Bars */}
